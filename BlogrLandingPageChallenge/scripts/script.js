...
document.querySelectorAll(".menuItm").forEach(menuItm => {
    ...
    const extendedMenu = menuItm.querySelector(".extendedMenu");
...
const menuToggler = document.querySelector("#mobileMenuToggler");
menuToggler.addEventListener("click", () => {
    const outerMenuDiv = document.querySelector("#outerMenuDiv");
